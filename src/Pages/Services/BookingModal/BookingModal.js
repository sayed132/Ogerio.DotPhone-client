...
const BookingModal = ({ bookingProduct, setBookingProduct, refetch }) => {
    const { productName, category_name, resellPrice, } = bookingProduct;
            ...
            <div className="modal">
                <div className="modal-box relative">
                    ...
                    <form onSubmit={handleBooking} className='grid grid-cols-1 gap-3 mt-10'>
                        ...
                        <input name="phone" type="text" placeholder="Type Your Phone Number" className="input w-full input-bordered" />
                        <input name="location" type="text" placeholder="Please Provide Your Location " className="input w-full input-bordered" />
                        <br />
