    ...
    return (
        <section className="dark:bg-gray-800 dark:text-gray-100">
            <div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
                <div>
                    <h2 className="text-3xl font-bold tracking-tight text-center sm:text-5xl dark:text-gray-50">More Features New Lunching Phone</h2>
                ...
                <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
                    <div>
                        <h3 className="text-2xl font-bold tracking-tight sm:text-3xl dark:text-gray-50">iPhone 14 Pro Max</h3>
                    ...
                    <div aria-hidden="true" className="mt-10 lg:mt-0">
                        <img src="https://www.mobiledokan.com/wp-content/uploads/2022/09/Apple-iPhone-14-Pro-Max.jpg" alt="" className="mx-auto rounded-lg shadow-lg dark:bg-gray-500" />
                    </div>
                </div>
                <div>
                    <div className="grid lg:gap-8 lg:grid-cols-2 lg:items-center">
                        <div className="lg:col-start-2">
                            <h3 className="text-2xl font-bold tracking-tight sm:text-3xl dark:text-gray-50">The Purple And The Beautiful</h3>
                        ...
                        <div className="mt-10 lg:mt-0 lg:col-start-1 lg:row-start-1">
                            <img src="https://www.notebookcheck.net/fileadmin/Notebooks/News/_nc3/14_Pro.jpg" alt="" className="mx-auto rounded-lg shadow-lg dark:bg-gray-500"/>
                        </div>
                    </div>
                </div>
            </div>
